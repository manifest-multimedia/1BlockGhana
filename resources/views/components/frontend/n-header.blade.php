<header id="header-section" class="header header2 container-fluid p_z">
    ...
    <div class="top-header">
        ...
        <div class="container">
            <p class="col-md-6 col-sm-9">
                ...
                <span><a title="mail-to" href="mailto:info@1blockghana.com"><i class="fa fa-envelope-o"></i> info@1blockghana.com</a></span>
            </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 logo-block no-padding">
                    <a title="logo" href="index.html"><img src="frontend/images/logo.png" alt="logo" /></a>
                </div><!-- Logo Block /- -->
                <!-- Menu Block -->
    ...
    <div class="container">
        <div class="pull-right">
            <a title="User" href="#" class="user-icon"><img src="frontend/images/icon/user-icon.png" alt="user icon" /></a>
