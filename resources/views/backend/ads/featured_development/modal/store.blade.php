<form action="{{ route('featured.development.store', $development->id) }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" data-backdrop="false" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <x-form.input name="priority" value="{{$development->status}}" required/>
                </div>
