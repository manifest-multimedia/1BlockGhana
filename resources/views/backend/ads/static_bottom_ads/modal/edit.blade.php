<form action="{{ route('developmentads.update', $development->id) }}" method="POST" enctype="multipart/form-data">
    {{ method_field('patch') }}
    {{ csrf_field() }}
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">
                        Update <span>{{$development->name}}</span> Priority</h6>
                ...
                <div class="modal-body">
                        ...
                        <x-form.input type="number" name="priority" value="{{$development->status}}" required/>
                </div>
