<form action="{{ route('amenity.update', $amenity->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="editModal{{$amenity->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" data-backdrop="false" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <x-form.input name="name" value="{{$amenity->name}}" required/>
                </div>
