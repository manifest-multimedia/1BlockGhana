                    ...
                    <div class="item">
                        <div class="slider__image__detail-large-one">
                            ...
                            <div class="description">
                                <figure>
                                    <img src="{{$development->business->user->getFirstMediaUrl('logos', 'thumb-100')}}" alt="" class="img-fluid">
                                </figure>
                                <span class="badge badge-primary text-capitalize mb-2">{{$development->purpose ?? ''}}</span>
                                <div class="price">
                                    <h5 class="text-capitalize">{{ $development->currency->code ?? '--' }}{{$development->price ?? ''}}</h5>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="similiar__item">
                    ...
                    <div class="similiar__development-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="card__image">
                                ...
                                <div class="card__image-footer">
                                    <figure>
                                        <img src="{{$development->business->user->getFirstMediaUrl('logos', 'thumb-100')}}" alt="" class="img-fluid rounded-circle">
                                    </figure>
