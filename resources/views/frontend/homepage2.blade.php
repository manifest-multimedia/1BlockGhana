                            ...
                            <div class="carousel__content">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="text-center col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="col-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            <button class="btn btn-primary text-uppercase btn-block"> search <i
                                    class="ml-1 fa fa-search"></i></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card__image">
                        ...
                        <div class="card__image-body">
                            <!-- <span class="p-1 mb-3 badge badge-secondary text-capitalize">May 08, 2019 </span> -->
                            <h6 class="text-capitalize">
                                ...
                                <li class="list-inline-item ">
                                    <a href="/blog-single.html" class="btn btn-sm btn-primary "><small
                                            class="text-white ">read more <i
                                                class="ml-1 fa fa-angle-right"></i></small></a>
                                </li>
                    ...
                    <div class="col-md-4">
                        <div class="widget__footer">
                            ...
                            <p>
                                ...
                                <button class="mr-1 btn btn-social btn-social-o youtube">
